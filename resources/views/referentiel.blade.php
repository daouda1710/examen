...
<body>
    ...
    <div class="card text-center">
        ...
        <div class="card-header mt-4 text-center text-dark">Formation {{ $type['libelle'] }}</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                ...
                <a href="/referentiels/{{ $referentiel['id'] }}" class="btn btn-primary">{{ $referentiel['libelle'] }} </a>  <br>
            </div>
